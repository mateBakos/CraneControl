...
[A, B, C, D] = ssdata(sys);
controller1 = 2209*(tf([0.1, 1],[0.0008 1]))^2; % q1
...
h1 = 0.0015; % sampling for q1
h2 = 0.0015; % sampling for q2
...
controller_2d = c2d(ss(controller2), h2, opt_con); % discr of contr for q1
